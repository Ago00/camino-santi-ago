...
(`/<coordinates>([sS]*?)</coordinates>/g`) sobre un fichero KML local y de
...
(`C:UserssantiDownloadscamino-de-santiago-portugues-1a-etapa-tui-porrino-2018.gpx`,
...
proyecto (`join(ROOT, ...)`). Tampoco quedó ninguna ruta `C:Users...`
